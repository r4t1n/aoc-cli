...
func CheckForCachedInput(year, day uint, userHomeDirectory string) (cachedInputExists bool, err error) {
	dateFolderPath := filepath.Join(userHomeDirectory, ".cache", "aoc-cli", strconv.Itoa(int(year)), strconv.Itoa(int(day)))
...
func CopyInput(year, day uint, userHomeDirectory string) error {
	cacheFilePath := filepath.Join(userHomeDirectory, ".cache", "aoc-cli", strconv.Itoa(int(year)), strconv.Itoa(int(day)), "input")
	filePath := "input"
...
func WriteInput(year, day uint, userHomeDirectory, input string) error {
	cacheFilePath := filepath.Join(userHomeDirectory, ".cache", "aoc-cli", strconv.Itoa(int(year)), strconv.Itoa(int(day)), "input")
